...
const BASE_URL = "https://kaboretech.cursusbf.com";  // Remplacez par l'URL de votre API
...
const Details = () => {
  ...
  const handleSubscribe = () => {
    // Vérifier si la catégorie existe et a un nom
    if (category && category.name) {
      ...
      console.error("La catégorie n'est pas définie ou n'a pas de nom");
      // Vous pouvez aussi afficher une alerte à l'utilisateur
      Alert.alert("Erreur", "Impossible de trouver les détails de la formation");
    }
  };
